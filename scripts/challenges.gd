...
const LEVELS := [
	{
		...
		"tiers": [5000, 9000, 13950, 20600], "measured": true,
		"unlocks_ability": -1,
	},
	{
		"id": "L2", "name": "COLD START",
		"rule": Rule.BOOST_ONLY, "duration": 60.0, "difficulty": 2,
		"tiers": [4250, 7650, 11850, 17500], "measured": true,
